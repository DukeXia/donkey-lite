...
import com.donkeycode.core.exception.UnrealizedException;
import com.donkeycode.core.exception.NotFoundException;
...
public class AbstractExceptionHandler extends ResponseEntityExceptionHandler {
     ...
     * @throws Exception
     */
    @ExceptionHandler(value = {ValidateIllegalArgumentException.class, ValidateIndexOutOfBoundsException.class, ValidateNullPointerException.class, NotFoundException.class})
