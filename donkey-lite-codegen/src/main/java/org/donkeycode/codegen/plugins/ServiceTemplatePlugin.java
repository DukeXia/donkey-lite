...
import org.donkeycode.codegen.file.GenerateByListTemplateFile;
import org.donkeycode.codegen.file.GenerateByTemplateFile;
 ...
 * @since 3.4.5
 */
public class ServiceTemplatePlugin extends PluginAdapter {
    /**
     * 默认的模板格式化类
     */
    public static final String DEFAULT_TEMPLATEFORMATTER = "org.donkeycode.codegen.formatter.FreemarkerTemplateFormatter";
    /**
     * 单个文件模式
     */
