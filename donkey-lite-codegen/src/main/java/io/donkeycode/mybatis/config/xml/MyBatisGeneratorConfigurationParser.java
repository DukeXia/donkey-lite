 ...
 *  limitations under the License.
 */
package io.donkeycode.mybatis.config.xml;
...
import io.donkeycode.mybatis.config.ColumnOverride;
import io.donkeycode.mybatis.config.ColumnRenamingRule;
import io.donkeycode.mybatis.config.CommentGeneratorConfiguration;
import io.donkeycode.mybatis.config.Configuration;
import io.donkeycode.mybatis.config.ConnectionFactoryConfiguration;
import io.donkeycode.mybatis.config.Context;
import io.donkeycode.mybatis.config.DomainObjectRenamingRule;
import io.donkeycode.mybatis.config.GeneratedKey;
import io.donkeycode.mybatis.config.IgnoredColumn;
import io.donkeycode.mybatis.config.IgnoredColumnException;
import io.donkeycode.mybatis.config.IgnoredColumnPattern;
import io.donkeycode.mybatis.config.JDBCConnectionConfiguration;
import io.donkeycode.mybatis.config.JavaClientGeneratorConfiguration;
import io.donkeycode.mybatis.config.JavaModelGeneratorConfiguration;
import io.donkeycode.mybatis.config.JavaTypeResolverConfiguration;
import io.donkeycode.mybatis.config.ModelType;
import io.donkeycode.mybatis.config.PluginConfiguration;
import io.donkeycode.mybatis.config.PropertyHolder;
import io.donkeycode.mybatis.config.SqlMapGeneratorConfiguration;
import io.donkeycode.mybatis.config.TableConfiguration;
