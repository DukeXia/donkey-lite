...
public class FileUtil {
    ...
    private static Template getTemplate(int type) throws IOException {
        switch (type) {
            ...
            case FreemarketConfigUtils.TYPE_MAPPERXML:
            ...
            case FreemarketConfigUtils.TYPE_COMM_EDIT_BIZ:
                return FreemarketConfigUtils.getInstance().getTemplate("CommEditBiz.ftl");
            case FreemarketConfigUtils.TYPE_COMM_QUERY_BIZ:
                return FreemarketConfigUtils.getInstance().getTemplate("CommQueryBiz.ftl");
            default:
                return null;
        }
    }
