...
public class Many2ManyInvoker extends AbstractInvoker {
    ...
    protected void initTasks() {
        taskQueue.initMany2ManyTasks(tableName, entityDescription, className, parentTableName, parentClassName, foreignKey, parentForeignKey, relationalTableName, tableInfos, parentTableInfos);
    }
