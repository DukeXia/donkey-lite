...
public class FreemarketConfigUtils {
    ...
    private static String path = new File(FreemarketConfigUtils.class.getClassLoader().getResource("generator").getFile()).getPath();
        ...
        if (null == configuration) {
            ...
            try {
                if (path.contains("jar")) {
                    configuration.setClassForTemplateLoading(FreemarketConfigUtils.class, "/generator");
                } else {
